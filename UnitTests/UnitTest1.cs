...
namespace UnitTests
{
    ...
    public class UnitTest1
    {
        ...
        public void TestMethod1()
        {
            ...
            Assert.AreEqual(0, SmallSteps003.Program.result_addition);
        ...
        public void TestMethod2()
        {
            ...
            SmallSteps003.Program.Main(null);
            Assert.AreEqual(0, SmallSteps003.Program.result_substraction);
        ...
        public void TestMethod3()
        {
            ...
            SmallSteps003.Program.Main(null);
            Assert.AreEqual(0, SmallSteps003.Program.result_multiply);
        ...
        public void TestMethod4()
        {
            ...
            SmallSteps003.Program.Main(null);
            Assert.AreEqual(0, SmallSteps003.Program.result_division);
        ...
        public void TestMethod5()
        {
            ...
            string expected = "Der Rechenking sagt 6 + 3 = 0" + Environment.NewLine;
            expected += "Der Rechenking sagt 6 - 3 = 0" + Environment.NewLine;
            expected += "Der Rechenking sagt 6 * 3 = 0" + Environment.NewLine;
            expected += "Der Rechenking sagt 6 / 3 = 0" + Environment.NewLine;
